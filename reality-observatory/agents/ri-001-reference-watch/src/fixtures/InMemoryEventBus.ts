...
/**
 * Minimal, deterministic in-memory Event Bus fixture for RI-001. Delivers to
 ...
 * (see docs/adr/0004); it exists solely to let RI-001 exercise the real
...
export class InMemoryEventBus implements EventBus {
  ...
  async subscribe<TPayload>(
    ...
    const id = `ri001-sub-${this.subscriptionSequence}`;
