...
/**
 * An evolving trust score attached to a Sensor or Agent, computed exclusively
 * by the Trust Engine (see docs/adr/0004) from the history of Evidence and
 * resolved Predictions attributable to that subject. Output of the system,
